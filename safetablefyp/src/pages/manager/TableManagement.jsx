...
const TableManagement = () => {
  ...
  // Initialize with 20 tables if empty on first load
  useEffect(() => {
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>Configure seats and zone for the new table.</DialogDescription>
                                </DialogHeader>
                                <div className="grid gap-4 py-4">
                                    <p className="text-sm text-muted-foreground">Add a new table to the floor plan?</p>
              ...
              return (
                <motion.div
                  ...
                  exit={{ opacity: 0, scale: 0.9 }}>
                                    ...
                                    <Card
                    className={`
                                            group p-4 cursor-pointer hover:shadow-xl transition-all duration-300 border-2
                                            flex flex-col items-center justify-between aspect-square relative overflow-hidden
            ...
            <Dialog open={!!selectedTable} onOpenChange={(open) => !open && setSelectedTable(null)}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Update status or remove this table.
                        </DialogDescription>
                    </DialogHeader>
